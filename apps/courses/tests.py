...
class CourseModelTests(TestCase):
    def setUp(self):
        ...
        self.module = Module.objects.create(course=self.course, title="Intro Module", order=1)
    ...
    def test_enrollment_str(self):
        ...
        self.assertEqual(str(enrollment), f"{self.student.email} enrolled in {self.course.title}")
